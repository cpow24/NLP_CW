...
class Experiment:
    def __init__(self, data_dir=None, dataset='litbank',
        ...
        self.seed = seed
        # data_dir = '/content/drive/MyDrive/University/MSc Machine Learning/Term 2/COMP0087 - SNLP/Coursework/long-doc-coref_edit/lrec2020-coref/data/litbank/overlap/0'
        # Prepare data info
            ...
            for dev_example in dev_examples:
                ...
                if threshold:
                    ...
                    for cur_threshold in threshold_range:
                        ...
                        recall = x['corr']/x['total_y']
                        x['fscore'] = 2 * prec * recall/(prec + recall + EPS)
        print("RECALL AND F1 SCORE ARE: ", recall, x['fscore'])
        if threshold:
